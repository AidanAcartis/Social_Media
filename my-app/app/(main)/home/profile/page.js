...
const tabClasses = 'flex items-center gap-2 px-4 py-2 text-sm font-normal text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-full transition-all duration-150'
const activeTabClasses = 'flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-800 bg-gray-100 rounded-full border border-gray-200 transition-all duration-150'
      ...
      <Card noPadding className="overflow-hidden border border-gray-100 rounded-2xl shadow-sm">
        ...
        <div className="relative px-5 pb-5">
          <div className="absolute -top-10 left-5">
            <Avatar size="lg" editable={true} className="ring-2 ring-white" />
          </div>
          <div className="pt-12 pl-24 md:pl-32">
            <h1 className="text-xl font-semibold text-gray-900">{user?.username || 'Chargement...'}</h1>
          ...
          <div className="space-y-3">
            {loading ? (
              <Card className="flex justify-center py-10">
                <div className="animate-spin rounded-full h-7 w-7 border border-gray-300 border-t-gray-600"></div>
              </Card>
            ) : userPosts.length > 0 ? (
              userPosts.map(post => (
              ...
              <Card className="text-center py-10">
                ...
                <p className="text-sm text-gray-400">Aucune publication pour le moment</p>
              </Card>
            )}
          </div>
        )}
          ...
          <div className="space-y-3">
            <Card className="rounded-2xl border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className="text-base font-medium text-gray-800">À propos de moi</h2>
              </div>
            ...
            <Card className="rounded-2xl border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className="text-base font-medium text-gray-800">Localisation</h2>
              </div>
        ...
        {activeTab === 'friends' && (
          <Card className="rounded-2xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-base font-medium text-gray-800">Mes amis</h2>
            </div>
        ...
        {activeTab === 'photos' && (
          <Card className="rounded-2xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-base font-medium text-gray-800">Mes fichiers</h2>
            </div>
